...
\subsection{Chinise Reamainder Theorem for General equations}
\begin{minted}{cpp}
...
\subsection{Games on arbitrary graphs}
\begin{minted}{cpp}
...
\subsection{SparseSegTree with Lazy}
\begin{minted}{cpp}
...
% \chapter*{Matematica}
\input{Teoria/Capitulos/Identidades}
\input{Teoria/Capitulos/TeoriaDosNumeros}
\input{Teoria/Capitulos/Combinatoria}
\input{Teoria/Capitulos/Geometria}
\input{Teoria/Capitulos/Grafos}
\input{Teoria/Capitulos/Strings}
\input{Teoria/Capitulos/Game}
\input{Teoria/Capitulos/Other}

...
Sometimes a move in a game divides the game into subgames that are indepen-dent of each other.
In this case, the Grundy number of the game is mex({g1, g2, . . . , gn}), where n is the number of
possible moves and gk = ak,1 ⊕ ak,2 ⊕ . . . ⊕ ak,m,
